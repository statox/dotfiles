...
module.exports = {
    config: { // {{{
        ...
        fontWeight: 'normal',
        fontWeightBold: 'bold',
        lineHeight: 1, // line height as a relative unit
        letterSpacing: 0, // letter spacing as a relative unit
        // }}}
        // Cursor {{{
        // terminal cursor background color and opacity (hex, rgb, hsl, hsv, hwb or cmyk)
        cursorColor: 'rgba(200,200,200,0.8)',
        ...
        selectionColor: 'rgba(255,248,231,1)',
